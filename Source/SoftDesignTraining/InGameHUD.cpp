...
void AInGameHUD::ShowUpdatedCounters()
{
	FString HUD = " Time elapsed before last event (in seconds) : " + FString::FromInt(GetWorld()->GetAudioTimeSeconds()) + "\r";
	FString SId;
